...
export const NetProfitCard = () => {
    ...
    return (
        <div className="bg-white rounded-xl shadow p-4 w-full max-w-md space-y-4">
            ...
            <div className="text-2xl font-bold text-gray-900">₹2,80,500</div>
            ...
            <div className="grid grid-cols-2 gap-3">
                <div className="bg-purple-50 p-3 rounded-lg space-y-1">
                    ...
                    <div className="text-lg font-bold text-gray-900">₹3,10,700</div>
                ...
                <div className="bg-purple-50 p-3 rounded-lg space-y-1">
                    ...
                    <div className="text-lg font-bold text-gray-900">58.2%</div>
                </div>
            </div>
        </div>
    );
